...
[assembly: MelonInfo(typeof(ShowSkillUpgradesHide.ShowSkillUpgradesHide), "Show Skill Upgrades (Hide Results)", "1.0.0", "Zephhyr")]
[assembly: MelonGame("", "smt3hd")]

namespace ShowSkillUpgradesHide
{
    internal class ShowSkillUpgradesHide : MelonMod
    {
                ...
                if (rstinit.GBWK != null)
                {
                    ...
                    if (data.PUpSkillResult != 0)
                    {
                        ...
                        if (__result.Contains("to change a skill..."))
                            __result = __result.Replace("to change a skill...", "to change <CO4>" + currentSkillName + "<CO0> into another skill...");
                    }
                }
            }
        }
