...
[assembly: MelonInfo(typeof(RedNumbers.RedNumbers), "Red Damage Numbers VS Enemies Below 25% HP", "0.9.5", "Zephhyr")]
[assembly: MelonGame("", "smt3hd")]

namespace RedNumbers
{
    internal class RedNumbers : MelonMod
    {
        ...
        [HarmonyPatch(typeof(nbActionProcess), "SetAllPacket")]
        ...
        [HarmonyPatch(typeof(nbMakePacket), "nbAddNumEffKoukaPacket")]
        ...
        [HarmonyPatch(typeof(nbMainProcess), "GetHitNum")]
