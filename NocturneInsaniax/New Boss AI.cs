...
namespace NocturneInsaniax
{
    internal partial class NocturneInsaniax : MelonMod
    {
        ...
        private class CheckAction_NONPatch
        {
            ...
            {
                if ((a.data.encno == 1270 || a.data.encno == 1271 || a.data.encno == 1272) && a.type != 3 && a.form.formindex >= 4 && !pushedSkillList.Contains((ushort)a.adata))
                    a.type = 0;
            }
        }
        ...
        private class CheckMukanNegoPatch
        {
            ...
            {
                if ((a.data.encno == 1270 || a.data.encno == 1271 || a.data.encno == 1272) && a.form.formindex >= 4)
                    __result = 0;
            }
        }
        ...
        private static void BossCerberusRAI(ref nbActionProcessData_t a, ref int code, ref int n)
        {
            ...
            var enemypcnt = nbMainProcess.nbGetMainProcessData().enemypcnt;
            ...
            else
            {
                switch (enemypcnt)
                {
                    ...
                    case 2:
                        {
                            if (nbMainProcess.nbGetMainProcessData().enemyunit.Where(x => x.id == 305 && x.hp < x.maxhp && x.flag != 0).Any())
                            {
                                int randomValue = random.Next(4);
                                switch (randomValue)
                                {
