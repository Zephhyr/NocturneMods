...
namespace NocturneInsaniax
{
    internal partial class NocturneInsaniax : MelonMod
    {
        ...
        private static void RagShop()
        {
            ...
            fclRagShopTable.fclRagItemTbl[9].ItemID = 32;
            fclRagShopTable.fclRagItemTbl[9].Rate[0].ItemID = 104;
            fclRagShopTable.fclRagItemTbl[9].Rate[0].Nums = 1;
            fclRagShopTable.fclRagItemTbl[9].Rate[1].ItemID = 110;
            fclRagShopTable.fclRagItemTbl[9].Rate[1].Nums = 1;
