...
[assembly: MelonInfo(typeof(ReworkedMitamaFusion25.ReworkedMitamaFusion25), "Reworked Mitama Fusion (25% stat increase cap)", "1.0.2", "Zephhyr")]
[assembly: MelonGame("", "smt3hd")]

namespace ReworkedMitamaFusion25
{
    internal class ReworkedMitamaFusion25 : MelonMod
    {
        ...
        private class StatIncreasePatch
        {
            ...
            {
                for (int i = 0; i <= 5; i++)
                    if (pStock.mitamaparam[i] >= (sbyte)(pStock.param[i] * 0.25))
                        pStock.mitamaparam[i] = (sbyte)(pStock.param[i] * 0.25);
            }
        }
    }
}